...
drag.src = chrome.runtime.getURL('./images/drag18.png')
...
<div style="display: flex; flex-direction: column; height: 450px; padding: 0px 40px; text-align: center; align-items: center; justify-content: center;">
  ...
  <div>
  <div style="padding: 15px 0px; text-align: left; border-bottom: 1px solid #ff5757">
    <p style="color: #ff5757; margin: 0px 10px 0px 0px; font-size: 16px; font-family: lato; font-weight: 800; letter-spacing: 0px; display: inline-block; line-height: 23px;">1.</p>
  ...
  <div style="padding: 15px 0px; text-align: left; border-bottom: 1px solid #ff5757">
    <p style="color: #ff5757; margin: 0px 10px 0px 0px; font-size: 16px; font-family: lato; font-weight: 800; letter-spacing: 0px; display: inline-block; line-height: 23px;">2.</p>
  ...
  <div style="padding: 15px 0px; text-align: left; border-bottom: 1px solid #ff5757">
    <p style="color: #ff5757; margin: 0px 10px 0px 0px; font-size: 16px; font-family: lato; font-weight: 800; letter-spacing: 0px; display: inline-block; line-height: 23px;">3.</p>
...
window.addEventListener("load", () => {
  ...
  addJob.addEventListener("click", (event) => {
    ...
    chrome.storage.local.get('token', function (result) {
      ...
      fetch('https://job-saver-be.herokuapp.com/users/addJob', {
        method: 'POST',
        headers: {
        ...
        .then((data) => {
          ...
          if (data.message === 'Job post created') {
            ...
            return fetch('https://job-saver-be.herokuapp.com/users/addJob', {
              method: 'GET',
              headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${accessToken}`
              ...
              .then((jobs) => {
                return jobs && jobs.forEach(job => {
                  if (job.column_id === 'column-1') {
                    fetch(`https://job-saver-be.herokuapp.com/users/updateJob/${job.id}`, {
                      method: 'PUT',
                      headers: {
                        'Content-Type': 'application/json',
                        Authorization: `Bearer ${accessToken}`,
